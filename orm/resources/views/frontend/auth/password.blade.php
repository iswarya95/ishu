...
}	/* Body text color - sets the font of Yahoo's Shortcuts to black. */
...
#headline p { color: #f5f0f1; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; font-size: 36px; text-align: center; margin-top:0px; margin-bottom:30px; }
#headline p a { color: #f5f0f1; text-decoration: none; }
.article-title { font-size: 18px; line-height:24px; color: #d73f29; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; }
.des-title { color: #d73f29; font-weight:bold; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; }
...
.footer-content-left { font-size: 11px; line-height: 16px; color: #ffffff; margin-top: 0px; margin-bottom: 15px; }
.footer-content-left a { color: #aeaeeb; font-weight: bold; text-decoration: none; }
.footer-content-right { font-size: 11px; line-height: 16px; color: #ffffff; margin-top: 0px; margin-bottom: 15px; }
.footer-content-right a { color: #aeaeeb; font-weight: bold; text-decoration: none; }
#footer { background-color: #425470; color: #ffffff; }
#footer a { color: #aeaeeb; text-decoration: none; font-weight: bold; }
#permission-reminder { white-space: normal; }

.img
{
background:'adminuser/images/citw.png';
}
</style>
...
<body>
	  ...
	  <tbody>
			 ...
			 <tbody><td class='w30' width='30'></td>
			 <td class='w255' width='255' valign='middle' align='right'>
			 <table class='w255' width='255' cellpadding='0' cellspacing='0' border='0'>
                <tbody><tr><td class='w255' width='255' height='28'></td></tr></tbody>
			 </table>
			 </td>
			 </tbody>
			 </table>

             <tr><td id='header' class='w640' width='640' align='center' bgcolor='#ffffff'>
			 <div align='center' style='text-align: center'>
			  <?php
    $pathToFile = 'adminuser/images/citw.png';
    ?>
    <img id='customHeaderImage' label='Header Image' editable='true' width='231' src="<?php echo $message->embed($pathToFile); ?>" class='w640' border='0' align='top' style='display: inline'>
    </a>
    		 </div></td></tr>
            ...
            <table class='w580' width='580' cellpadding='0' cellspacing='0' border='0'>
			                <tbody><tr><td class='w580' width='580'>
                            <p align='left' class='article-title'><singleline label='Title'>Hi {{$user->name}}</singleline></p>
                            </td></tr>
