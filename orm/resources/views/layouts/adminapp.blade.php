                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if ( !Auth::guard('admin')->check() ) 
                            <li><a href="{{ url('admin/login') }}" class="contentcontainer med left" style="margin-left: 900px;">Admin Login</a></li>
                   ...
                   ?>
                        <div class="btn-group">
                            ...
                            <div class="btn-group hidden-nav-xs">
                                <a href="{{url('admin/order/create',$id)}}" type="button" class="btn btn-sm btn-primary dropdown-toggle">
                                    Add a order
                                </a>
                            </div>
                        </div>
                    ...
                    <section class="w-f scrollable">
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                            ...
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav">
                                    <li  class="active">
                                        <a href="{{ url('admin/order') }}""   class="active">
