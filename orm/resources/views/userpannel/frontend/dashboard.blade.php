...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | CITWffff</title>
...
<section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
        ...
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
            <li class="hidden-xs"><a href="#" class="dropdown-toggle"> {{Auth::guard('user')->user()->name}}</a></li>
            <li class="dropdown">
                    ...
                    <header class="header bg-primary lter text-center clearfix">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn-group hidden-nav-xs">
                                <a href="{{ url('admin/order/create') }}" type="button" class="btn btn-sm btn-primary dropdown-toggle">
                                    Add a order
                                </a>
                            </div>
                        </div>
