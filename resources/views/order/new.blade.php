                ...
                {!! Form::open(array('url'=>'admin/order/store')) !!}
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Name</label>
                            {!! Form::text('name',$admin->name, [ 'class'=>'form-control input-lg','required','disabled'=>'disabled']) !!}
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
                            {!! Form::text('phone', '', ['placeholder'=>'Enter phone number', 'class'=>'form-control input-lg','maxlength' => 10,'required']) !!}
                        </div>
                        <div class="form-group">
                            <label>Address</label>
